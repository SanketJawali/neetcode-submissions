class Solution:
    def findMedianSortedArrays(self, nums1: List[int], nums2: List[int]) -> float:
        # len of num lists, m and n
        # both lists are sorted

        # We find the middle most value in the first list
        # We then find this value in the second list
        # We then count the number of steps to the median of the list 2
